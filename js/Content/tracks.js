window.tracks = {
  ...
  f1Y91: {
    brasil: {
      ...
      figures: [
        // guard rails
        {
          ...
          scaleX: 28,
          scaleY: 18,
          imageSrc: '/assets/images/trackside/guardRailLeftLight.png',
          name: 'guardRailLeftLight',
          distance: 10,
          offset: 0,
          kerbs: true,
          curves: true,
        ...
        },
        {
          ...
          scaleX: 28,
          scaleY: 18,
          imageSrc: '/assets/images/trackside/guardRailLeftDark.png',
          name: 'guardRailLeftDark',
          distance: 10,
          offset: 5,
          kerbs: true,
          curves: true,
        ...
        },
        {
          ...
          scaleX: 28,
          scaleY: 18,
          imageSrc: '/assets/images/trackside/guardRailRightLight.png',
          name: 'guardRailRightLight',
          distance: 10,
          offset: 0,
          kerbs: true,
          curves: true,
        ...
        },
        {
          ...
          scaleX: 28,
          scaleY: 18,
          imageSrc: '/assets/images/trackside/guardRailRightDark.png',
          name: 'guardRailRightDark',
          distance: 10,
          offset: 5,
          kerbs: true,
          curves: true,
        ...
        // curve signals
        {
          ...
          scaleX: 72,
          scaleY: 72,
          imageSrc: '../assets/images/trackside/leftSignalRail.png',
          name: 'tsCurveSignalGuardRail',
          distance: 20,
          kerbs: true,
        },
        {
          ...
          scaleX: 72,
          scaleY: 72,
          imageSrc: '../assets/images/trackside/rightSignalRail.png',
          name: 'tsCurveSignalGuardRail',
          distance: 20,
          kerbs: true,
        },
    ...
    belgica: {
      ...
      curves: [
        { min: 668, max: 989, curveInclination: 6, kerb: 1 },
        { min: 1586, max: 1886, curveInclination: 0.5, kerb: 0 },
        { min: 2251, max: 2371, curveInclination: -4, kerb: 1 },
        { min: 2391, max: 2605, curveInclination: 3, kerb: 1 },
        { min: 2672, max: 2832, curveInclination: -5, kerb: 1 },
        { min: 3116, max: 3216, curveInclination: 1, kerb: 0 },
        { min: 4375, max: 4593, curveInclination: 4, kerb: 1 },
        { min: 4623, max: 4836, curveInclination: -5, kerb: 1 },
        { min: 4957, max: 5197, curveInclination: 4, kerb: 1 },
        { min: 5838, max: 6239, curveInclination: 3, kerb: 1 },
        { min: 6400, max: 6661, curveInclination: -4, kerb: 1 },
        { min: 6854, max: 7068, curveInclination: 0.5, kerb: 0 },
        { min: 7389, max: 7613, curveInclination: -4.5, kerb: 1 },
        { min: 7879, max: 8097, curveInclination: -4.5, kerb: 1 },
        { min: 8584, max: 8812, curveInclination: 4, kerb: 1 },
        { min: 8812, max: 9040, curveInclination: -4, kerb: 1 },
        { min: 9386, max: 9761, curveInclination: 4, kerb: 1 },
        { min: 9948, max: 10329, curveInclination: 3, kerb: 1 },
        { min: 10689, max: 10903, curveInclination: 1, kerb: 0 },
        { min: 11090, max: 11291, curveInclination: -3, kerb: 1 },
        { min: 11598, max: 11765, curveInclination: -5, kerb: 1 },
        { min: 12015, max: 12300, curveInclination: 0.5, kerb: 0 },
        { min: 12500, max: 12600, curveInclination: -3, kerb: 1 },
        { min: 12650, max: 12750, curveInclination: 4, kerb: 1 },
        { min: 12950, max: 13050, curveInclination: 4, kerb: 1 },
        { min: 13100, max: 13200, curveInclination: -3, kerb: 1 },
        { min: 13398, max: 13798, curveInclination: -2.5, kerb: 1 },
      ],
      hills: [
        { initialSegment: 1, size: 850, altimetry: 5 },
        { initialSegment: 888, size: 1250, altimetry: -35 },
        { initialSegment: 2265, size: 550, altimetry: 80 },
        { initialSegment: 2805, size: 1500, altimetry: -10 },
        { initialSegment: 4350, size: 950, altimetry: 20 },
        { initialSegment: 5612, size: 1000, altimetry: -40 },
        { initialSegment: 7339, size: 850, altimetry: 20 },
        { initialSegment: 8400, size: 1400, altimetry: -25 },
        { initialSegment: 10000, size: 3100, altimetry: 15 },
        { initialSegment: 13236, size: 600, altimetry: 5 },
        { initialSegment: 13936, size: 0, altimetry: 0 },
      ],
      tunnels: [
        {
          min: 0, max: 0, name: '', height: 1,
